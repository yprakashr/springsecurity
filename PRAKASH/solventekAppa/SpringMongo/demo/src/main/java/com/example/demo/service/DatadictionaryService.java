	 ...
	 public Optional<Datadictionary> getDatadictionaryById(Long id) {
	   ...
	   public Datadictionary createDatadictionary(Datadictionary datadictionary) {
	    ...
	    public Datadictionary updateInsurance(long id, Datadictionary insurance) {
	        ...
	        Query query = new Query(Criteria.where("ddid").is(id).and("projectId").is(insurance.getProjectId()));
	        Update update = new Update()
	            .set("dictionaryname", insurance.getDictionaryname())
	            .set("formFields", insurance.getFormFields());
	   ...
	   public List<Datadictionary> getDatadictionaryByProjectId(Long id) { return datadictionaryRepository.findByprojectId(id); }
